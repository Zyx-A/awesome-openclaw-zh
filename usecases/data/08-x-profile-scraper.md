...
- `csv`
- `filesystem`
- `config/x-targets.json`
- `skills/x-scraper/index.js`
- `SKILL.md`
- `cron`
...
```text
你是我的 OpenClaw 助手，请帮我完成「X 个人资料抓取器」。
...
4. 使用我已启用的技能（优先：web_fetch、web_search、csv、filesystem、config/x-targets.json、skills/x-scraper/index.js）。
